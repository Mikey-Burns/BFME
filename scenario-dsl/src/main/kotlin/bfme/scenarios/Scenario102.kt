...
fun twoCornerChaosCreateAHero(): String = livingWorldCampaign {
    ...
    description =
        "This is a 6 player game with preset starting locations where two humans are split between the north-east and south-west. Players start with a Create A Hero army."
    number = 102

    scenario {
        name = "LWScenario:WOTRScenario102"
        description = "LWScenario:WOTRScenario102Description"
